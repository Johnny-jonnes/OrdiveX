    ...
    return `
      <div class="print-footer">
        ...
        <div class="print-footer-center">
          <p class="print-legal">Document gÃ©nÃ©rÃ© par OrdiveX v9.7.48t</p>
  ...
  async printSaleReceipt(saleId) {
    ...
    win.document.write(`
      ...
      <div class="ticket-container">
        ...
        <p class="ticket-legal">OrdiveX v9.7.48t - ${saleDate.toLocaleDateString('fr-FR')}</p>
      </div>
    `);
    win.document.close();
  ...
  async printInvoice(saleId) {
    ...
    win.document.write(`
      ...
      <div class="inv">
        ...
        <div class="inv-lg">Document gÃ©nÃ©rÃ© par OrdiveX v9.7.48t Â· ImprimÃ© le ${new Date().toLocaleDateString('fr-FR')} Ã  ${new Date().toLocaleTimeString('fr-FR')} Â· ${pName}</div>
      </div>
    `);
    win.document.close();
    win.onload = () => win.print();
  ...
  async printPurchaseOrder(orderId) {
    ...
    win.document.write(`
      ...
      <div class="inv">
        ...
        <div class="inv-lg">Document généré par OrdiveX v9.7.48t · Imprimé le ${new Date().toLocaleDateString('fr-FR')} à ${new Date().toLocaleTimeString('fr-FR')} · ${pName}</div>
      </div>
    `);
    win.document.close();
    win.onload = () => win.print();
...
PrintEngine.printPurchaseOrder = async function(orderId) {
  ...
  win.document.write(`
    ...
    <div class="bc">
      ...
      <div class="bc-lg">Document gÃ©nÃ©rÃ© par OrdiveX v9.7.48t Â· ${new Date().toLocaleDateString('fr-FR')} Â· ${pName}</div>
    </div>
  `);
  win.document.close();
  win.onload = () => win.print();
